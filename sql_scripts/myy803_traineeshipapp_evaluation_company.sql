...
--
-- Table structure for table `evaluation_company`
--

DROP TABLE IF EXISTS `evaluation_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluation_company` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKwegfmw4ysa8gyxdgblvubmby` (`traineeship_position_id`),
  KEY `FKlnixuuk6uusscgdxid80qlu72` (`evaluator_id`),
  CONSTRAINT `FK2kpa98lh3nvftplymxxlstkoj` FOREIGN KEY (`traineeship_position_id`) REFERENCES `traineeship_position` (`id`),
  CONSTRAINT `FKlnixuuk6uusscgdxid80qlu72` FOREIGN KEY (`evaluator_id`) REFERENCES `company` (`id`)
